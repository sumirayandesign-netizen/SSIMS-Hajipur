...
function Page() {
  return (
    <>
      <PageHero eyebrow="Community Impact" title="Care that reaches every village of Bihar." subtitle="Because early detection saves lives, and no one should be left behind because of distance or income." crumbs={[{ label: "Community" }]} />
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-4 md:grid-cols-3">
            <img src={community} alt="" className="col-span-2 h-80 w-full object-cover rounded-3xl shadow-soft" loading="lazy" />
            <img src={facility} alt="" className="h-80 w-full object-cover rounded-3xl shadow-soft" loading="lazy" />
            <img src={research} alt="" className="h-80 w-full object-cover rounded-3xl shadow-soft" loading="lazy" />
            <img src={blood} alt="" className="col-span-2 h-80 w-full object-cover rounded-3xl shadow-soft" loading="lazy" />
          </div>
          ...
          <div className="mt-20">
            <div className="text-center max-w-2xl mx-auto">
              <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-primary">Ways to give</div>
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={c.t} className="rounded-3xl overflow-hidden bg-white shadow-soft ring-1 ring-border/50 hover:-translate-y-1 hover:shadow-glow transition-all">
